...
const FAQS = [
  ...
  },
  {
    ...
    a: "Positives is the foundation: daily guided audio, weekly principles, monthly themes, and the member library. Positives Plus adds live member events and replay access as those sessions are published. Coaching sessions are sold separately as add-on packages when you want more direct support.",
  },
];
